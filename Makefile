...
install: $(PLUGIN)
	...
	install -m 644 logo/16/barev_white.png "$(DESTDIR)$(ICON_DIR)/16/barev.png"
	install -m 644 logo/22/barev_white.png "$(DESTDIR)$(ICON_DIR)/22/barev.png"
	install -m 644 logo/48/barev_white.png "$(DESTDIR)$(ICON_DIR)/48/barev.png"
	install -m 644 logo/scalable/barev_white.svg "$(DESTDIR)$(ICON_DIR)/scalable/barev.svg"
